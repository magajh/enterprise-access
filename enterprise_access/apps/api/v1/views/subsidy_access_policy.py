...
class SubsidyAccessPolicyViewSet(
    ...
    def destroy(self, request, *args, uuid=None, **kwargs):
        ...
        delete_reason = request_serializer.data['reason']
        ...
        if policy_to_soft_delete.active:
            policy_to_soft_delete._change_reason = delete_reason  # pylint: disable=protected-access
            # Custom delete() method should flip the active flag.
            policy_to_soft_delete.delete()
